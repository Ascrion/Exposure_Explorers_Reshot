...
import 'package:exposure_explorer_reshot/screens/mobile/home_page_mobile.dart';
import 'edit_photos_mobile.dart';
          ...
          children: [
            Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              Row(
                children: [
                  SizedBox(
                    width: width*0.5*iconScale, // set width
                  ...
                  SizedBox(
                    width: width*0.3*iconScale,  // set width
                    child: ElevatedButton(
